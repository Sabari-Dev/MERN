...
let avgRating = superMarket.reduce((acc, rating) => acc + rating.rating, 0);
let rating = avgRating / superMarket.length;
document.write(`<b>Average Rating :</b> ${rating}<br>`);

//  2. Calculate the averageHeight of all the element
let avgHeight = superMarket.reduce((acc, high) => acc + high.height, 0);
let Height = avgHeight / superMarket.length;
document.write(`<br><b>Average Height For all element :</b> ${Height}<br>`);
//  3. Calculate the averageWidth of all the element
let avgWidth = superMarket.reduce((acc, Wid) => acc + Wid.width, 0);
let Width = avgWidth / superMarket.length;
document.write(`<br><b>Average Width For all element :</b> ${Width}<br>`);
//4. Calculate the averagePrice of all the element
let avgPrice = superMarket.reduce((acc, price) => acc + price.price, 0);
let Price = avgPrice / superMarket.length;
document.write(`<br><b>Average Price For all element :</b> ${Price}<br>`);
