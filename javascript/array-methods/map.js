...
let addMarket = superMarket.map((market) => {
  return { ...market, isAvailable: true };
});
document.write(
  `<h2><u>Add the property ‘isAvailable: true’ to all the elements</u></h2>`
);
addMarket.forEach((market) => {
